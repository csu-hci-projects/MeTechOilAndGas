...
namespace HoloToolkit.Unity
{
    ...
    public class WorldAnchorManager : Singleton<WorldAnchorManager>
    {
        ...
        ///Custom Code
        /// <summary>
        /// This method will return a list of all anchor names in the world anchor store
        /// To be used for HUD and Debug purposes
        /// </summary>
        public string[] GetAllAnchorNames()
        {
            if (AnchorStore != null) { 
                string[] AnchorNames = new string[AnchorStore.anchorCount];
                AnchorStore.GetAllIds(AnchorNames);
                return AnchorNames;
            }
            return new string[0];
        }
        ...
        {
            return AnchorStore.anchorCount;
        }
